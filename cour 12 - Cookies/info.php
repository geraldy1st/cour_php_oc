<?php
setcookie('pseudo', 'Leedy', time() + 365*24*3600, null, null, false, true); // On écrit un cookie
setcookie('pays', 'Korea', time() + 365*24*3600, null, null, false, true); // On écrit un autre cookie...
